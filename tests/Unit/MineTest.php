...
class MineTest extends TestCase
{
   ...
   #[Test] public function set_Mines() {
    ...
    #[Test] public function no_mines_around_first_click()
    {
        ...
        foreach ($aroundTiles as $coords) {
            $this->assertFalse($board[$coords['y']][$coords['x']]->isMine());
        }
    }


    #[Test] public function too_many_mines()
    {
    ...
    #[Test]  public function invalid_first_click()
    {
        $this->expectException(InvalidArgumentException::class);
